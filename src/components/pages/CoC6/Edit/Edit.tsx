...
import { faCopy, faSadTear } from '@fortawesome/free-regular-svg-icons'
import {
  faEye,
  faEyeSlash,
  faGlobe,
...
import ParametersSection from './organisms/ParametersSection'
import ProfileSection from './organisms/ProfileSection'
import SkillsetSection from './organisms/SkillsetSection'
import './styles.css'
...
const Editor = ({ init, secured }: { init: Character; secured: boolean }) => {
